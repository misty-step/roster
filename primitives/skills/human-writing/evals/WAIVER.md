# /human-writing eval waiver

expires: 2026-09-15

## Reason

Prose-quality rubric is taste-heavy in the same way as `council`; needs an operator-anchored calibration grade before an agent grader's verdict can be trusted, not yet scheduled.
...
at `primitives/skills/human-writing/evals/human-writing-eval.md` (see `primitives/skills/skill-eval/templates/eval-spec.md`)
